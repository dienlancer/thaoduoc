...
class ProductController{	
	...
	public function contact(){	
        ...
        $mail->Port = @$data["smpt_port"];
        $mail->SMTPSecure = @$data["encription"];
        $mail->SMTPAuth = true;
        $mail->Username = @$data["smtp_username"];
        $mail->Password = @$data["smtp_password"];
        $mail->setFrom(@$data["email_from"], @$_POST["txtFullName"]);
        $mail->addAddress(@$data["email_to"], @$data["to_name"]);
        $mail->Subject = 'Khách hàng '. @$_POST["txtFullName"] . " - Số điện thoại : " . @$_POST["txtPhone"] ;       
        $strContent=@$_POST["txtContent"] . "\n\n" . " Điện thoại : " . @$_POST["txtPhone"]; 
